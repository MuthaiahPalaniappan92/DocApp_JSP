<%-- 
    Document   : jobsearch
    Created on : 2-Aug-2015, 1:00:04 PM
    Author     : c0652674
--%>
    ...
    <body>
        <div data-role="page" id="home"data-title="Careers">
            ...
            <%
                ...
                ResultSet rs=d.jobList();
                out.print("<table>");
                while(rs.next()){
                    out.print("<tr><td><b>Job Title:<a href='candidate_details.jsp?jobid="+rs.getString("jobid")+"' >"+rs.getString("title")+"</a></b></td>");
                    out.print("<td><b>Experience Required:</b>"+rs.getInt("exp_required")+"</td>");
                    out.print("<td><b>Requirements :</b>"+rs.getString("requirements")+"</td>");
                    out.print("<td><b>Responsibility :</b>"+rs.getString("responsibilities")+"</td>");
                }
                out.print("</table>");
            %>
