<%-- 
    Document   : products
    Created on : 19-Jul-2015, 12:36:51 AM
    Author     : c0652674
--%>
...
<html>
    ...
    <body>
        <div data-role="page" id="home" data-title="Product Details">
            <header data-role="header">
                ...
                <div data-role="navbar">
                    <ul>
                        ...
                        <li><a href="" data-theme="c" class="ui-btn-active" data-icon="grid" data-transition="pop">Products</a></li>
